      ...
      <div className="w-full max-w-md">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-8 relative z-10">
            <div className={`p-4 rounded-2xl mb-4 transition-colors duration-500 ${error ? 'bg-red-500/10 text-red-400' : 'bg-indigo-500/10 text-indigo-400'}`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full bg-slate-950 border ${error ? 'border-red-500/50 focus:border-red-500' : 'border-slate-800 focus:border-indigo-500'} rounded-xl py-3 pl-11 pr-4 text-white placeholder-slate-600 outline-none transition-all`}
          ...
          {error && (
            <div className="mt-4 text-center">
              <span className="text-xs text-red-400 bg-red-500/10 px-3 py-1 rounded-full animate-fade-in">
